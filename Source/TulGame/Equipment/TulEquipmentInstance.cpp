...
APawn* UTulEquipmentInstance::GetPawn() const
{
    return Cast<APawn>(GetOuter());
}

void UTulEquipmentInstance::SpawnEquipmentActors(const TArray<FTulEquipmentActorToSpawn>& ActorsToSpawn)
{
    if (APawn* OwningPawn = GetPawn())
    {
        ...
        for (const FTulEquipmentActorToSpawn& SpawnInfo : ActorsToSpawn)
        {
...
void UTulEquipmentInstance::DestroyEquipmentActors()
{
...
APawn* UTulEquipmentInstance::GetTypedPawn(TSubclassOf<APawn> PawnType) const
{
...
void UTulEquipmentInstance::OnEquipped()
{
    K2_OnEquipped();
}

void UTulEquipmentInstance::OnUnequipped()
{
    K2_OnUnequipped();
}
