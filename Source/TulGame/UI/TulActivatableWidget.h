...
#include "TulActivatableWidget.generated.h"

/**
* Input 처리 방식 정의
*/
UENUM(BlueprintType)
enum class ETulWidgetInputMode : uint8
{
	Default,
	GameAndMenu,
	Game,
 ...
 */
UCLASS()
class TULGAME_API UTulActivatableWidget : public UCommonActivatableWidget
{
	GENERATED_BODY()
public:
	UTulActivatableWidget(const FObjectInitializer& ObjectInitializer);
	...
	*/
	...
	ETulWidgetInputMode InputConfig = ETulWidgetInputMode::Default;
